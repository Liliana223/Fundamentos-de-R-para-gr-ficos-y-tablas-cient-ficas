...
datos_largos <- datos %>% #Operador %>%. El pipe (%>%) permite encadenar funciones y leer el código como una secuencia de pasos.
  pivot_longer(
...
datos_nuevo <- datos %>%
  relocate(relaciones_area, .after = especie) #Puedo indicar antes o despues
